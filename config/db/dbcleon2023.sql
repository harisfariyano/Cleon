...
--
-- Host: localhost
-- Generation Time: Dec 12, 2023 at 11:45 AM
...
(1, 'About Us', 'Cleon adalah suatu layanan yang disediakan oleh PT. Sarana InsanMuda Selaras dalam pengembangan Wifi. Cleon cocok dipasang pada kost, kontrakan, kantor, maupun warung-warung yang ramai dikunjungi.\r\nAlternatif layanan yang memberikan kemudahan bagi pelanggan dalam menikmati layanan internet dimana tidak perlu berlangganan cukup dengan membeli voucher ketika akan menggunakan internet.', 'Cleon adalah suatu layanan yang disediakan oleh PT. Sarana InsanMuda Selaras', 'about.jpg', 'Ut fugiat ut sunt quia veniam. Voluptate perferendis perspiciatis quod nisi et. Placeat debitis quia recusandae odit et consequatur voluptatem. Dignissimos pariatur consectetur fugiat voluptas ea. Temporibus nihil enim deserunt sed ea. Provident sit expedita aut cupiditate nihil vitae quo officia vel. Blanditiis eligendi possimus et in cum. Quidem eos ut sint rem veniam qui. Ut ut repellendus nobis tempore doloribus debitis explicabo similique sit.\r\n', 'Voluptatem dignissimos provident quasi corporis', 'about-2.jpg', 'Ut fugiat ut sunt quia veniam. Voluptate perferendis perspiciatis quod nisi et. Placeat debitis quia recusandae odit et consequatur voluptatem. Dignissimos pariatur consectetur fugiat voluptas ea. Temporibus nihil enim deserunt sed ea. Provident sit expedita aut cupiditate nihil vitae quo officia vel. Blanditiis eligendi possimus et in cum. Quidem eos ut sint rem veniam qui. Ut ut repellendus nobis tempore doloribus debitis explicabo similique sit');
...
--
-- Table structure for table `filter_button`
--
...
--
-- Dumping data for table `filter_button`
--

INSERT INTO `filter_button` (`id`, `button1`, `button2`, `button3`, `button4`, `button5`) VALUES
(1, 'semua', 'Time Base', 'Paket Kuota', 'Unlimited', 'SS');
...
(1, 'assets/img/cleon_icon.png', 'Jl. Parangtritis Km. 1 No. 97, Brontokusuman, Kec. Mergangsan, Kota Yogyakarta, 55143', 'cleon.jogjamedianet@gmail.com', '+6285174328821', '', '', '');
...
(11, 'Wireless', 'Paket Used Based', 'KUOTA 5k', 5.000, '5 Hari', '5 GB', 2.50, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(12, 'Wireless', 'Paket Used Based', 'KUOTA 10K', 10.000, '10 hari', '10 GB', 2.50, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(13, 'Wireless', 'Paket Used Based', 'KUOTA 20K', 20.000, '15 Hari', '20 GB', 2.50, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(14, 'Wireless', 'Paket Used Based', 'KUOTA 30K', 30.000, '20 Hari', '30 GB', 2.50, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(15, 'Wireless', 'Paket Used Based', 'KUOTA 40K', 40.000, '30 Hari', '40 GB', 2.50, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(16, 'Wireless', 'Paket Unlimited', 'HEMAT 1', 60.000, '30 Hari', 'Unlimited', 1.60, 'Untuk pengguna yang ingin menggunakan internet sebulan penuh tanpa perlu takut kuota habis, layanan ini sangat cocok.'),
(18, 'Wireless', 'Paket Unlimited', 'HEMAT 2', 100.000, '30 hari', 'Unlimited', 2.50, 'Untuk pengguna yang ingin menggunakan internet sebulan penuh tanpa perlu takut kuota habis, layanan ini sangat cocok.'),
(25, 'Wireless', 'Paket SS', 'Paket SS 1 ', 50.000, '30 hari', '50 Gb', 1.60, 'Paket baru dari cleon yang bisa dipakai untuk 2 perangkat secara bersamaan, jadi bisa ngerjain tugas di laptop sambil main sosmed di gadget.'),
(31, 'Wireless', 'Paket SS', 'Paket SS 2', 100.000, '30 Hari', '100 GB', 1.60, 'Paket baru dari cleon yang bisa dipakai untuk 2 perangkat secara bersamaan, jadi bisa ngerjain tugas di laptop sambil main sosmed di gadget.'),
(128, 'Wireless', 'Paket Time Based', 'Paket 10 Jam', 5.000, '1 hari', '10 Jam', 2.50, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(129, 'Fiber Optik', 'Paket Unlimited', 'HEMAT FO 1', 30.000, '30 Hari', 'Unlimited', 1.20, 'Untuk pengguna yang ingin menggunakan internet sebulan penuh tanpa perlu takut kuota habis, layanan ini sangat cocok.'),
(130, 'Fiber Optik', 'Paket Unlimited', 'HEMAT FO 2', 60.000, '30 Hari', 'Unlimited', 3.00, 'Untuk pengguna yang ingin menggunakan internet sebulan penuh tanpa perlu takut kuota habis, layanan ini sangat cocok.'),
(131, 'Fiber Optik', 'Paket Unlimited', 'HEMAT FO 3', 100.000, '30 Hari', 'Unlimited', 4.00, 'Untuk pengguna yang ingin menggunakan internet sebulan penuh tanpa perlu takut kuota habis, layanan ini sangat cocok.'),
(134, 'Wireless', 'Paket Time Based', '24 Jam', 10.000, '1 Hari', '24 Jam', 2.50, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(136, 'Wireless', 'Paket Used Based', 'KUOTA FO 10K', 10.000, '10 hari', '20 Gb', 4.00, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(138, 'Fiber Optik', 'Paket Used Based', 'KUOTA FO 20K', 20.000, '20 Hari', '20 GB', 4.00, 'Cocok untuk pengguna yang melakukan akses internet untuk kebutuhan ringan seperti chating, cek, dan kirim email, update sosmed, bahkan main game.'),
(139, 'Wireless', 'Paket Time Based', 'Paket 3 Jam', 2.000, '1 Hari', '3 Jam', 2.50, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(140, 'Fiber Optik', 'Paket Time Based', 'Paket 3 Jam', 2.000, '1 Hari', ' 3 Jam', 5.00, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(141, 'Fiber Optik', 'Paket Time Based', 'Paket 8 Jam', 5.000, '1 Hari', '8 Jam', 5.00, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(142, 'Fiber Optik', 'Paket Time Based', 'Paket 15 Jam', 10.000, '1 Hari', '15 Jam', 5.00, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(143, 'Fiber Optik', 'Paket Time Based', 'Paket 24 Jam', 15.000, '1 Hari', '24 Jam', 5.00, 'Cocok untuk pengguna yang suka download dan akses data yang besar dalam waktu tertentu.'),
(144, 'Fiber Optik', 'Paket Used Based', 'KUOTA FO 5K', 5.000, '5 Hari', '10 GB', 4.00, 'Cocok untuk user yang melakukan akses internet untuk kebutuhan data ringan seperti, chating, cek dan kirim email, update sosmed, bahkan main game');
...
--
-- Indexes for table `filter_button`
--
...
--
-- AUTO_INCREMENT for table `apuser`
--
ALTER TABLE `apuser`
...
--
-- AUTO_INCREMENT for table `filter_button`
--
ALTER TABLE `filter_button`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
